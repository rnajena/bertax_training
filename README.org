...
- declaration of "conventional" neural network architectures like
  ...
  [[file:utils/test_model.py]] (used for comparison in the development of BERTax)
...
#+begin_src shell
  python -m models.bert_nc single_sequences_json_folder --batch_size 32 --head_num 5 \
...
and fine-tuned with:
#+begin_src shell
  python -m models.bert_nc_finetune bert_nc_C2.h5 single_sequences_json_folder/ --multi_tax \
