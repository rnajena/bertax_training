...
if __name__ == '__main__':
    ...
    dir = "/home/go96bix/projects/dna_class/resources/filtered/"
    ...
    for name, df in [("query",df_test), ("db_bert", df_train)]:
        with open(f"/data/fass2/projects/fm_read_classification_comparison/filtered_database/{name}.fa","w") as outfile:
